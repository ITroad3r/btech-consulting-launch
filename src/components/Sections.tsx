        ...
        <div className="grid gap-12 md:grid-cols-4">
          <div>
            ...
            <div className="mt-6 flex items-center gap-3">
              <a href="https://www.linkedin.com/company/btech-consulting/" target="_blank" rel="noopener noreferrer" className="h-9 w-9 rounded-lg bg-primary/10 text-primary flex items-center justify-center hover:bg-primary/20 transition-colors" aria-label="LinkedIn">
              ...
              <a href="https://www.instagram.com/b.tech_consulting" target="_blank" rel="noopener noreferrer" className="h-9 w-9 rounded-lg bg-primary/10 text-primary flex items-center justify-center hover:bg-primary/20 transition-colors" aria-label="Instagram">
              ...
              <a href="https://www.facebook.com/share/1D7cTeYLVM" target="_blank" rel="noopener noreferrer" className="h-9 w-9 rounded-lg bg-primary/10 text-primary flex items-center justify-center hover:bg-primary/20 transition-colors" aria-label="Facebook">
              ...
              <a href="https://www.tiktok.com/@btechconsulting" target="_blank" rel="noopener noreferrer" className="h-9 w-9 rounded-lg bg-primary/10 text-primary flex items-center justify-center hover:bg-primary/20 transition-colors" aria-label="TikTok">
                <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4"><path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93v6.16c0 2.52-.64 5.03-2.28 6.88-1.64 1.85-4.11 2.76-6.57 2.76-1.44 0-2.88-.36-4.15-1.07-1.27-.71-2.27-1.78-2.86-3.06-.59-1.28-.77-2.7-.51-4.08.26-1.38.91-2.64 1.86-3.6.95-.96 2.17-1.61 3.51-1.86 1.34-.25 2.73-.09 3.97.45v4.17c-.61-.33-1.3-.5-2-.5-1.34 0-2.57.67-3.29 1.79-.72 1.12-.83 2.53-.29 3.75.54 1.22 1.61 2.12 2.88 2.39 1.27.27 2.6-.06 3.58-.86.98-.8 1.55-1.99 1.55-3.25V0h4.02z"/></svg>
              </a>
              <a href="https://www.youtube.com/channel/UCiTPQ5u-nSYlQCgSWX46ZEg" target="_blank" rel="noopener noreferrer" className="h-9 w-9 rounded-lg bg-primary/10 text-primary flex items-center justify-center hover:bg-primary/20 transition-colors" aria-label="YouTube">
